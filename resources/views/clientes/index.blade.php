...
<div class="modal fade" id="nuevoCliente" tabindex="-1" aria-hidden="true" data-keyboard="false" aria-labelledby="nuevoClienteLabel" data-backdrop="static">
    ...
    <div class="container ml-5 ml-md-0">
        ...
        <button type="button" style="border-radius: 1rem;" data-target="#nuevoCliente" data-toggle="modal" class="float-right btn btn-nuevo-cliente text-white mb-5"><img src="{{ '/images/anadir.png' }}" width="50px"  alt=""> Nuevo
            Cliente</button>
