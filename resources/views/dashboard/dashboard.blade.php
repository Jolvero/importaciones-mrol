<section data-aos="fade-down" data-aos-duration="1000" class="ml-5 ml-md-0">
    <h3 class="font-weight-bold mb-5 mr-5 mr-md-0 p-3 card card-body text-center">Bienvenido/a {{ $nombre }}</h3>
            ...
            <div class="card ml-3">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <p class="font-weight-bold ml-3">{{ $embarques }} Importaciones</p>
                    </div>
                </div>
            </div>
        </div>
