...
Vue.component('fecha-embarque', require('./components/FechaEmbarque.vue').default);
Vue.component('eliminar-embarque', require('./components/EliminarEmbarque.vue').default);
